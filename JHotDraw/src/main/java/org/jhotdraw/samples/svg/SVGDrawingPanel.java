...
public class SVGDrawingPanel extends JPanel {
    ...
    public void setEditor(DrawingEditor newValue) {
        ...
        // Added the toolbar to the editor selection.
        // The .form has also been changed by adding the FontAwesomeToolBar to the list of tools.
        
        fontAwesomeToolBar.setEditor(editor);
    ...
    private void initComponents() {
        ...
        fontAwesomeToolBar = new org.jhotdraw.samples.svg.gui.FontAwesomeToolBar();
        ...
        fontAwesomeToolBar.setRollover(true);
        toolsPane.add(fontAwesomeToolBar);
    ...
    private org.jhotdraw.samples.svg.gui.FontAwesomeToolBar fontAwesomeToolBar;
